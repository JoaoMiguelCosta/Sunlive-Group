// src/brands/sports/pages/LeisureSportsTourism/OverviewSection.jsx
...
/**
 * Secção "Mais do que Treino / Uma Jornada de Descoberta"
 * + barra de pilares (União / Bem Estar / Enriquecimento Global)
 */
export default function OverviewSection({ data }) {
  ...
  return (
    <section
      ...
      aria-label="Turismo Desportivo Lúdico — Sunlive Sports"
    >
      <TextMediaSection
        id={overview?.id}

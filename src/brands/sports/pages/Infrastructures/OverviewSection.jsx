// src/brands/sports/pages/Infrastructures/OverviewSection.jsx
...
/**
 * Secção "A base do Alto Rendimento" + barra de pilares (Infraestruturas)
 */
export default function OverviewSection({ data }) {
  ...
  return (
    <section
      ...
      aria-label="Infraestruturas de Alto Rendimento — Sunlive Sports"
    >
      <TextMediaSection
        id={overview?.id}

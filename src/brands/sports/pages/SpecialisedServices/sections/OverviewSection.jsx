// src/brands/sports/pages/SpecialisedServices/sections/OverviewSection.jsx
...
const PILL_ICONS = {
  prevention: GLOBAL_ICONS.ShieldIcon, // Global
  monitor: BRAND_ICONS.MonitorIcon, // Sports
  recycle: BRAND_ICONS.RecycleIcon, // Sports
};

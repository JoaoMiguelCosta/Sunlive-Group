// src/brands/sports/pages/Education/EducationBilingualCertification.jsx
import styles from "./EducationBilingualCertification.module.css";

/**
 * Card largo "Certificação Dupla" dentro do Ensino Bilingue.
 *
 * Uso:
 *   <EducationBilingualCertification data={education} />
 */
      ...
      <div className={styles.inner}>
        <article className={styles.card}>
          <header className={styles.cardHeader}>
            {/* Placeholder de ícone — podes trocar mais tarde */}

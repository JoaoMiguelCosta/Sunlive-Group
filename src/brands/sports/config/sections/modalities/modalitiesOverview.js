const modalitiesOverview = {
  ...
  intro: {
    ...
    lead: "As modalidades da Sunlive Sports organizam-se por contextos técnicos distintos, com programas, academias e projetos ajustados às exigências de cada desporto.",
  },
  ui: {
    ariaLabel: "Visão geral das modalidades da Sunlive Sports",
    listAriaLabel: "Lista de modalidades disponíveis",
    cardActionLabel: "Explorar",
  },
  items: [
    {
      key: "cycling",
...
export default modalitiesOverview;

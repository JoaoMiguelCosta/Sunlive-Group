const trainingCampsHero = {
  ...
  ui: {
    ariaLabel: "Introdução à página Training Camps da Sunlive Sports",
    proofListAriaLabel: "Pontos-chave dos Training Camps",
    statsAriaLabel: "Destaques dos Training Camps",
  },
};

export default trainingCampsHero;
